...
# Dictionary to store orders in progress for each session
inprogress_orders = {}
...
async def handle_request(request: Request):
    ...
    # Dictionary mapping intent names to corresponding handler functions
    intent_handler_dict = {
...
def remove_from_order(parameters: dict, session_id: str):
    if session_id not in inprogress_orders:
        return JSONResponse(content={"fulfillmentText": "I'm having trouble finding your order. Can you place a new order please?"})
